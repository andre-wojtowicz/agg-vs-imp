...
# vector length is equal to the number of classifiers declared in config.R
OWA.WEIGTHS.VECTOR.LENGTH = length(CLASSIFIERS.LIST)
OWA.WEIGTHS.VECTOR.INC = seq(0, 1, length.out = OWA.WEIGTHS.VECTOR.LENGTH)
    # orig: c(0,0.25,0.5,0.5,0.75,1)
OWA.WEIGTHS.VECTOR.DEC = seq(1, 0, length.out = OWA.WEIGTHS.VECTOR.LENGTH)
    # orig: c(1,0.75,0.5,0.5,0.25,0)
OWA.WEIGTHS.VECTOR.HILL = c(head(seq(0.1, 1, length.out = OWA.WEIGTHS.VECTOR.LENGTH/2),
                                 ifelse((OWA.WEIGTHS.VECTOR.LENGTH %% 2) == 0,
                                        OWA.WEIGTHS.VECTOR.LENGTH/2,
                                        floor(OWA.WEIGTHS.VECTOR.LENGTH/2))),
                            seq(1, 0.1, length.out = OWA.WEIGTHS.VECTOR.LENGTH/2))
    # orig: c(0.1,0.5,1,1,0.5,0.1)
OWA.WEIGTHS.VECTOR.PIT = c(head(seq(1, 0.1, length.out = OWA.WEIGTHS.VECTOR.LENGTH/2),
                                ifelse((OWA.WEIGTHS.VECTOR.LENGTH %% 2) == 0,
                                       OWA.WEIGTHS.VECTOR.LENGTH/2,
                                       floor(OWA.WEIGTHS.VECTOR.LENGTH/2))),
                           seq(0.1, 1, length.out = OWA.WEIGTHS.VECTOR.LENGTH/2))
    # orig: c(1,0.5,0.1,0.1,0.5,1)
...
AGGR.MEASURES = c(MEASURE.CARDINALITY)
AGGR.MEASURES.NAME = c('card')
