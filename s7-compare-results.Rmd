...
The following tables present predictors used by the classifiers and performance
measures. P-value checks through one sample t-test whether mean accuracy from folds
is significantly greater than 0.5.

```{r classifiers-original, results="asis"}
for (dataset.name in DATASETS.NAMES)
{
            ...
            .combine   = rbind) %do%
    {
        ...
        pval = t.test(attr(model, "folds.performance")$Accuracy, mu = 0.5, 
